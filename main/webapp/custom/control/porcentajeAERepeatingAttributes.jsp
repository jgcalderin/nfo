...
<%@ page import="com.sepe.nfo.controls.PercentClasesAEDocbaseRepeatingAttribute" %>
	...
	height='313' titlenlsid='MSG_REPEATING_ATTRIBUTE_TITLE'>
		<dmf:form autofocusneeded="true">
			<%
				...
				PercentClasesAEDocbaseRepeatingAttribute docbaseRepeatingAttribute = (PercentClasesAEDocbaseRepeatingAttribute) form;
				//
			%>
			...
			<dmf:paneset name="contentareaPaneset" cols="18,*,18"
				...
				<dmf:pane name="scrollingcontent" overflow="auto">
					...
					<p>
						Especifique los porcentajes de contración:
						<br>
					</p> 
						...
						<tr>
							...
							<td>
								<table border="1">
									...
									<th>Porcentaje (%)</th>
									<%
										List<String> clasesAE = docbaseRepeatingAttribute.getClasesAEAttributeValue();
										int i=0;
										for (String clase:clasesAE)
										{
											%>
											<tr>
												<td><%=clase %></td>
												<td align=center><dmf:text name='<%=i + "c0" %>' size="5" maxlength="5"/></td>
											</tr>
											<%i++;%>
										<%}%>
								</table>
