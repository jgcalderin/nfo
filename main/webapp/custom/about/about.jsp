...
<tr>
	<td scope="row" class="leftAlignment">
		<dmf:label label="Customizado para Necesidades de Formación" style="font-weight:bold"/>
		<span class="defaultcolumnspacer">: </span>
		<dmf:label label="versión 1.4"/>
	</td>
</tr>
<tr>
	<td scope="row" class="leftAlignment">
		<dmf:label label="Conexión" style="font-weight:bold"/>
		<span class="defaultcolumnspacer">: </span>
		<dmf:label label='<%=SessionManagerHttpBinding.getUsername() + "[" + SessionManagerHttpBinding.getCurrentDocbase() + "]"%>'/>
	</td>
</tr>
</table>
...
<p>&copy; 1994-2011 EMC Corporation. All rights reserved.</p>
</div>
</div>
</div>
...
<dmf:button name='<%=About.CONTROL_CLOSE%>' nlsid='MSG_OK' onclick='onClose' default='true' tooltipnlsid='MSG_OK'/>
</div>
</div>
</div>
</dmf:form>
